      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-zinc-700">
          ...
          <section>
            ...
            <p>If you have questions about this Privacy Policy or your data, you may contact MedicalRouter using the contact information provided on the site: <a href="mailto:[CONTACT_EMAIL]" className="text-blue-700 underline hover:text-blue-900">[CONTACT_EMAIL]</a>.</p>
          </section>
